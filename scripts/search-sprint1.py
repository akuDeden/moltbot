#!/usr/bin/env python3
"""
Search for pages containing "Sprint 1" in Notion
Usage: python3 search-sprint1.py
"""
import sys
import json
...
def search_sprint1(notion):
    """Search for pages with 'Sprint 1' or 'sprint 1'"""
    try:
        # Search for pages containing "Sprint 1"
...
def main():
    ...
    print(f"🔍 Searching for 'Sprint 1'...\n")

    # Get sprint 1 pages
    pages = search_sprint1(notion)

    if not pages:
        print("❌ No pages found with 'Sprint 1'")
        sys.exit(0)

    print(f"📋 SPRINT 1 TICKETS ({len(pages)}):\n")
